...
const GeometricBackgroundSlate = () => {
  return (
    <div className="absolute inset-0 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-slate-600 via-zinc-500 to-slate-700"></div>
      ...
      <div className="absolute top-1/2 left-1/4 transform -translate-y-1/2">
        <div className="relative">
          {Array.from({ length: 8 }).map((_, i) => (
            <div
              key={i}
              className="absolute w-20 h-40 bg-gradient-to-r from-slate-400/20 to-zinc-400/20 backdrop-blur-sm rounded-lg border border-white/10"
              style={{
      ...
      <div className="absolute top-1/3 right-1/4 transform">
        <div className="relative">
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="absolute w-16 h-32 bg-gradient-to-r from-zinc-400/20 to-slate-400/20 backdrop-blur-sm rounded-lg border border-white/10"
              style={{
...
export default GeometricBackgroundSlate;
